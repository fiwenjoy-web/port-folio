  ...
  return (
    <motion.div
      ...
      <div className={`relative ${aspectRatio} overflow-hidden`}>
        ...
        <div className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0"
          ...
          <div className="flex items-end justify-between gap-2">
            <div>
              ...
              <h3 className="text-xl leading-tight" style={{ fontFamily: SANS, fontWeight: 700, color: "#fff" }}>
                {t(project.titleBT ?? { en: project.title, th: project.title })}
              </h3>
            </div>
