...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  portfolio: {
    ...
    projects: [
      {
        title: { en: "MONTHLY CAMPAIGN COLLECTION", th: "รวมผลงานแคมเปญรายเดือน" },
        category: { en: "Campaign Design", th: "การออกแบบแคมเปญ" },
        description: {
          en: "A curated collection of monthly Shopee and Lazada campaigns created from January to June 2026, showing a wide range of seasonal visual directions and promotional styles.",
          th: "รวมผลงานแคมเปญรายเดือนสำหรับ Shopee และ Lazada ตั้งแต่เดือนมกราคมถึงมิถุนายน 2026 แสดงทิศทางภาพตามฤดูกาลและสไตล์โปรโมชันที่หลากหลาย",
        },
        tags: ["Photoshop", "Shopee / Lazada", "Monthly Campaigns"],
        caseStudy: createCaseStudy({
          overview: {
            en: "An ongoing collection of monthly marketplace campaigns designed for real promotional periods across Shopee and Lazada.",
            th: "รวมผลงานแคมเปญมาร์เก็ตเพลสที่ออกแบบต่อเนื่องในแต่ละเดือนสำหรับช่วงโปรโมชันจริงบน Shopee และ Lazada",
          },
          goal: {
            en: "Give every campaign a distinct seasonal identity while keeping products, discounts, coupons, and calls to action immediately readable.",
            th: "สร้างเอกลักษณ์ตามฤดูกาลให้แต่ละแคมเปญ พร้อมรักษาความชัดเจนของสินค้า ส่วนลด คูปอง และปุ่มกระตุ้นการตัดสินใจ",
          },
          concept: {
            en: "Different month, different visual world. A repeatable campaign workflow supports styles ranging from corporate and festive to playful pixel art, tropical scenes, neon retail, and minimal product presentation.",
            th: "แต่ละเดือนมีโลกของภาพต่างกัน โดยใช้เวิร์กโฟลว์แคมเปญที่ทำซ้ำได้เพื่อรองรับทั้งสไตล์องค์กร เทศกาล พิกเซลอาร์ต ทรอปิคอล นีออน และภาพสินค้าแบบมินิมอล",
          },
          direction: [
            { en: "Seasonal visual range", th: "ทิศทางภาพตามฤดูกาลที่หลากหลาย" },
            { en: "Marketplace-ready hierarchy", th: "ลำดับข้อมูลที่พร้อมใช้บนมาร์เก็ตเพลส" },
            { en: "Clear product and offer communication", th: "สื่อสารสินค้าและข้อเสนออย่างชัดเจน" },
          ],
          visualSystem: [
            { label: { en: "Campaign Framework", th: "โครงแคมเปญ" }, desc: { en: "A repeatable structure for headline, offer, product group, coupon, and CTA.", th: "โครงสร้างที่ใช้ซ้ำได้สำหรับหัวแคมเปญ ข้อเสนอ ชุดสินค้า คูปอง และ CTA" } },
            { label: { en: "Seasonal Art Direction", th: "ทิศทางภาพตามฤดูกาล" }, desc: { en: "Each month receives its own palette, atmosphere, props, and visual energy.", th: "แต่ละเดือนมีชุดสี บรรยากาศ องค์ประกอบ และพลังของภาพเป็นของตัวเอง" } },
            { label: { en: "Offer Hierarchy", th: "ลำดับข้อมูลโปรโมชัน" }, desc: { en: "Discounts and campaign benefits stay readable across changing styles.", th: "ส่วนลดและสิทธิประโยชน์ยังอ่านง่ายแม้เปลี่ยนสไตล์ของแคมเปญ" } },
            { label: { en: "Product Presentation", th: "การนำเสนอสินค้า" }, desc: { en: "Product groups are arranged to remain clear, credible, and purchase-focused.", th: "จัดชุดสินค้าให้ชัดเจน น่าเชื่อถือ และสนับสนุนการตัดสินใจซื้อ" } },
          ],
          outputs: [
            { label: { en: "New Year Grand Sale", th: "แคมเปญ New Year Grand Sale" }, desc: { en: "A clean New Year campaign balancing a warm family image, product focus, and a clear promotional price.", th: "แคมเปญปีใหม่ที่สมดุลภาพครอบครัว ชุดสินค้า และราคาส่งเสริมการขายอย่างชัดเจน" } },
            { label: { en: "February Mid-Month", th: "แคมเปญกลางเดือนกุมภาพันธ์" }, desc: { en: "A high-energy red campaign using bold type and offer cards for fast marketplace communication.", th: "แคมเปญสีแดงพลังสูง ใช้ตัวอักษรเด่นและการ์ดข้อเสนอเพื่อสื่อสารบนมาร์เก็ตเพลสอย่างรวดเร็ว" } },
            { label: { en: "Valentine Mid-Month", th: "แคมเปญวาเลนไทน์กลางเดือน" }, desc: { en: "A seasonal pink direction combining Valentine motifs, product variety, and coupon-led offers.", th: "ทิศทางสีชมพูตามเทศกาล ผสมองค์ประกอบวาเลนไทน์ สินค้าหลากหลาย และข้อเสนอแบบคูปอง" } },
            { label: { en: "Summer Health Sale", th: "แคมเปญ Summer Health Sale" }, desc: { en: "A long-form tropical campaign built around a pool scene, summer energy, and marketplace pricing.", th: "แคมเปญแนวยาวในฉากสระน้ำ ใช้พลังแบบฤดูร้อนร่วมกับราคาและข้อเสนอสำหรับมาร์เก็ตเพลส" } },
            { label: { en: "Shopee 3.3 Campaign", th: "แคมเปญ Shopee 3.3" }, desc: { en: "Bold orange composition designed to communicate the 3.3 offer and product range at a glance.", th: "องค์ประกอบสีส้มที่สื่อสารข้อเสนอ 3.3 และชุดสินค้าให้เข้าใจได้ในครั้งเดียว" } },
            { label: { en: "Songkran Campaign", th: "แคมเปญสงกรานต์" }, desc: { en: "A Thai seasonal visual combining water-festival imagery, people, products, and coupon tiers.", th: "ภาพตามฤดูกาลไทยที่รวมบรรยากาศเทศกาลน้ำ บุคคล สินค้า และระดับคูปอง" } },
            { label: { en: "Lazada 5.5 Campaign", th: "แคมเปญ Lazada 5.5" }, desc: { en: "A softer purple retail system balancing headline offers with a grounded product presentation.", th: "ระบบภาพค้าปลีกสีม่วงที่สมดุลหัวข้อโปรโมชันกับการนำเสนอสินค้าอย่างเป็นระเบียบ" } },
            { label: { en: "Back to School Campaign", th: "แคมเปญ Back to School" }, desc: { en: "A playful pixel-art school campaign. AI was used only to extend the background; all copy, logos, student, and product assets come from the original layered artwork.", th: "แคมเปญโรงเรียนสไตล์พิกเซลอาร์ต ใช้ AI ช่วยเฉพาะการขยายฉากหลัง ส่วนข้อความ โลโก้ นักเรียน และสินค้ามาจากไฟล์ต้นฉบับแบบแยกเลเยอร์" } },
            { label: { en: "May Payday Campaign", th: "แคมเปญ Payday เดือนพฤษภาคม" }, desc: { en: "A neon retail direction using a glowing stage and floating products to create depth and urgency.", th: "ทิศทางภาพนีออนที่ใช้แท่นเรืองแสงและสินค้าลอยเพื่อสร้างมิติและความเร่งด่วน" } },
            { label: { en: "Dr. Hygiene 6.6", th: "แคมเปญ Dr. Hygiene 6.6" }, desc: { en: "A minimal blue-white campaign with a premium clinical atmosphere and restrained product composition.", th: "แคมเปญสีฟ้าขาวแบบมินิมอล ให้บรรยากาศพรีเมียมเชิงคลินิกและจัดสินค้าอย่างเรียบคุม" } },
          ],
          reflection: {
            en: "This collection demonstrates consistent monthly production, fast adaptation to seasonal briefs, and the ability to change visual style without losing product clarity or commercial purpose.",
            th: "คอลเลกชันนี้แสดงการผลิตงานอย่างต่อเนื่องในแต่ละเดือน การปรับตัวตามโจทย์ฤดูกาล และความสามารถในการเปลี่ยนสไตล์โดยไม่เสียความชัดเจนของสินค้าและเป้าหมายเชิงพาณิชย์",
          },
        }),
      },
      {
      ...
      },
      {
        ...
        caseStudy: createCaseStudy({
          ...
          goal: {
            ...
            th: "เปลี่ยนข้อมูลสินค้าที่มีรายละเอียดมากให้เป็นลำดับภาพที่อ่านง่ายบนมือถือ พร้อมรักษาบุคลิกที่อ่อนโยน สนุก และช่วยให้ผู้ปกครองเข้าใจสินค้าได้อย่างรวดเร็ว",
          },
          concept: {
            en: "Gentle care in a friendly illustrated world. Soft mint and sky-blue colors, rounded forms, playful characters, and large product renders make practical information feel approachable without losing commercial clarity.",
            th: "การดูแลอย่างอ่อนโยนในโลกภาพประกอบที่เป็นมิตร ใช้สีมิ้นต์และฟ้าอ่อน รูปทรงโค้ง ตัวละครสนุก และภาพสินค้าขนาดใหญ่ เพื่อทำให้ข้อมูลใช้งานจริงดูเข้าถึงง่ายโดยยังคงความชัดเจนเชิงพาณิชย์",
          },
          direction: [
            { en: "Friendly child-oriented illustration", th: "ภาพประกอบที่เป็นมิตรกับกลุ่มครอบครัวและเด็ก" },
            { en: "Clear mobile information hierarchy", th: "ลำดับข้อมูลชัดเจนสำหรับการดูบนมือถือ" },
            { en: "Consistent mint and sky-blue brand palette", th: "ระบบสีมิ้นต์และฟ้าอ่อนที่สม่ำเสมอ" },
          ...
          outputs: [
            ...
            { label: { en: "Detailed Product Information", th: "รายละเอียดผลิตภัณฑ์" }, desc: { en: "A checklist layout expands the approved product information while preserving a strong product focal point and playful visual identity.", th: "เลย์เอาต์แบบเช็กลิสต์ขยายข้อมูลผลิตภัณฑ์ที่อนุมัติ โดยยังรักษาจุดเด่นของสินค้าและเอกลักษณ์ภาพที่สนุก" } },
            { label: { en: "How-to-use Guide", th: "คู่มือวิธีใช้งาน" }, desc: { en: "A three-step instruction visual combines real usage photographs with large readable guidance for practical product understanding.", th: "ภาพคำแนะนำสามขั้นตอนผสานภาพถ่ายการใช้งานจริงกับข้อความขนาดใหญ่ เพื่อให้เข้าใจวิธีใช้ได้ง่าย" } },
            { label: { en: "Pack Options & Purchase Choice", th: "ตัวเลือกแพ็กและการตัดสินใจซื้อ" }, desc: { en: "One-, two-, and three-bottle options are organized into clear selection cards, with the featured pack receiving stronger visual emphasis.", th: "จัดแพ็กหนึ่ง สอง และสามขวดเป็นการ์ดตัวเลือกที่ชัดเจน พร้อมเน้นแพ็กหลักด้วยน้ำหนักภาพที่เด่นกว่า" } },
